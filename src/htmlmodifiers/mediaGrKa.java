...
public class mediaGrKa {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(scannerMediaMap.hasNextLine())/*for(int i = 1; i<=6756; i++)*/{   //5787 is last line without an error  added space at end of line in some instances and may fixed error
            ...
            currentLine[0] = "Katavasias (Greek)";
        ...
        try {
            FileWriter myWriter = new FileWriter("C:/git/ages-alwb-system/net.ages.liturgical.workbench.system/MEDIA_INDEX_UTILITY/output/grKA.html");
            myWriter.write(fs);
            myWriter.close();
