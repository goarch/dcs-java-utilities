...
<!--   Michael Colburn: I set the doctype-public to "" because during the ePub generation
		it caused the javax.xml.parsers.SAXParser.parse method to go into a loop
...
<xsl:template name="head.content">
  ...
  <!-- Michael Colburn - 3/15/13 - added the following <meta http-equiv... 
       to prevent browsers from incorrectly rending spaces -->
